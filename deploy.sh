...
if ! dig +short intdeliv.siteboosty.com | grep -qi "github"; then rm -f "$TMP/CNAME"; echo "DNS intdeliv ещё не настроен — публикую без домена"; fi
cd "$TMP"
...
rm -rf "$TMP"
[ -f admin/CNAME ] && dig +short intdeliv.siteboosty.com | grep -qi github && echo "OK: https://intdeliv.siteboosty.com/" || echo "OK: https://tjmermta.github.io/intdeliv/"
